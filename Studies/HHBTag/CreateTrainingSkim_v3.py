...
def createSkim(inFile, outFile, run, period, sample, X_mass, node_index, mpv, snapshotOptions):
    jetVar_list = [ "pt", "eta", "phi", "mass", "btagDeepFlavB", "btagPNetB", "genMatched", "partonFlavour"] # "HHBtagScore" excluded for now until I can test the new version for Run3
    ...
    colToSave+=["GenJet_b_PF", "GenJet_Hbb_PF", "GenJet_idx", "GenJet_Hbb", "GenJet_b_true"]
