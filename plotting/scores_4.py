...
for sample in samples:
    ...
    for tag in taggers_loop:
        ...
        df1 = df1.Filter("RecoJet_pt.size() == 4")
...
plt.savefig(f"output/{sample_name}/scores_4jets/firstjet_scores.png", dpi=300)
...
plt.xlim(-0.2,2.2)
plt.legend(handles=legend_elements, loc='upper right')
plt.savefig(f"output/{sample_name}/scores_4jets/secondjet_scores.png", dpi=300)
...
plt.xlim(-0.2,2.2)
plt.legend(handles=legend_elements, loc='upper right')
plt.savefig(f"output/{sample_name}/scores_4jets/thirdjet_scores.png", dpi=300)
...
plt.xlim(-0.2,2.2)
plt.legend(handles=legend_elements, loc='upper right')
plt.savefig(f"output/{sample_name}/scores_4jets/fourthjet_scores.png", dpi=300)