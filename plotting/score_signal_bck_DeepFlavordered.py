...
#     df = df.Define("FirstJet_HHBtagScore", "RecoJet_pt.size() >= 1 ? RecoJet_HHBtagScore[0] : -1")
#     df = df.Define("SecondJet_HHBtagScore", "RecoJet_pt.size() >= 2 ? RecoJet_HHBtagScore[1] : -1")
...
plt.savefig("output/scores_DeepFlavordered/firstjet_scores_signal_bck.png", dpi=300)
...
plt.xlim(-0.2,2.2)
# plt.legend(loc='upper right')
plt.savefig("output/scores_DeepFlavordered/firstjet_scores_signal_bck_2RecoJet.png", dpi=300)
...
# plt.yscale('log')
plt.xlim(-0.2,2.2)
plt.savefig("output/scores_DeepFlavordered/secondjet_scores_signal_bck.png", dpi=300)
...
for sample in samples:
    ...
    plt.savefig(f"output/scores_DeepFlavordered/2Dplot_{sample}.png", dpi=300)
    plt.clf()
...
for sample in samples:
    ...
    plt.ylabel("Second Jet HHBtag")
    plt.title(f"Lead Jet vs Second Jet for {label[samples.index(sample)]}")
    plt.savefig(f"output/scores_DeepFlavordered/2Dplot_{sample}_2RecoJets.png", dpi=300)
    plt.clf()
...
# plt.yscale('log')
plt.xlim(-0.2,2.2)
plt.savefig("output/scores_DeepFlavordered/scores_signal_bck.png", dpi=300)
...
# plt.yscale('log')
plt.xlim(-0.2,2.2)
plt.savefig("output/scores_DeepFlavordered/scores_signal_bck_2RecoJet.png", dpi=300)
...
# plt.yscale('log')
plt.xlim(-0.2,2.2)
plt.savefig("output/scores_DeepFlavordered/scores_signal.png", dpi=300)
...
# plt.yscale('log')
plt.xlim(-0.2,2.2)
plt.savefig("output/scores_DeepFlavordered/scores_signal_2RecoJet.png", dpi=300)
...
for sample in signal_samples:
    ...
    f = p + sample
    df = ROOT.RDataFrame("Event", f)
    df = df.Define("FirstJet_HHBtagScore", "RecoJet_pt.size() >= 1 ? RecoJet_HHBtagScore[0] : std::numeric_limits<float>::quiet_NaN()")
    df = df.Define("SecondJet_HHBtagScore", "RecoJet_pt.size() >= 2 ? RecoJet_HHBtagScore[1] : std::numeric_limits<float>::quiet_NaN()")
    hist2D = df.Histo2D(("hist2D", "2D plot of FirstJet_HHBtagScore vs SecondJet_HHBtagScore", bins_x, x_min, x_max, bins_y, y_min, y_max), "FirstJet_HHBtagScore", "SecondJet_HHBtagScore")
...
for sample in signal_samples:
    ...
    plt.ylabel("Second Jet HHBtag")
    plt.title(f"Lead Jet vs Second Jet for {signal_label[signal_samples.index(sample)]}")
    plt.savefig(f"output/scores_DeepFlavordered/2Dplot_{sample}_2RecoJet.png", dpi=300)
    plt.clf()
