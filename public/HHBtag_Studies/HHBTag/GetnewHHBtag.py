...
jetVar_list = [ "pt", "eta", "phi", "mass", "btagDeepFlavB", "particleNetAK4_B", "HHBtagScore", "genMatched", "hadronFlavour"]
...
def createSkim(inFile, outFile, period, sample, X_mass, node_index, mpv, config, snapshotOptions):
    ...
    colToSave = ["event","luminosityBlock",
                ...
                "channel","sample","period","X_mass", "node_index"] 
                #,"MET_pt", "MET_phi", "PuppiMET_pt", "PuppiMET_phi","DeepMETResolutionTune_pt", "DeepMETResolutionTune_phi","DeepMETResponseTune_pt", "DeepMETResponseTune_phi"]
