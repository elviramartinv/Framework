...
def createSkim(inFile, outFile, period, sample, X_mass, node_index, mpv, config):
    Baseline.Initialize(True, True)

    df = ROOT.RDataFrame("Events", inFile)
    # df = df.Range(10)
    df = df.Filter("event == 15074")
...
if __name__ == "__main__":
    ...
    createSkim(args.inFile, args.outFile, args.period, args.sample, args.mass, args.node_index, args.mpv, config)
