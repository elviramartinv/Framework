...
CombineHarvesterCombineTools_PRE_INIT_FUNC += $$(eval $$(call LCGDict,CombineHarvesterCombineTools,src/CombineHarvester/CombineTools/src/classes.h,src/CombineHarvester/CombineTools/src/classes_def.xml,$(SCRAMSTORENAME_LIB),$(GENREFLEX_ARGS) $(root_EX_FLAGS_GENREFLEX_FAILES_ON_WARNS)))
...
HiggsAnalysisCombinedLimit_PRE_INIT_FUNC += $$(eval $$(call LCGDict,HiggsAnalysisCombinedLimit,src/HiggsAnalysis/CombinedLimit/src/classes.h,src/HiggsAnalysis/CombinedLimit/src/classes_def.xml,$(SCRAMSTORENAME_LIB),$(GENREFLEX_ARGS) $(root_EX_FLAGS_GENREFLEX_FAILES_ON_WARNS)))
