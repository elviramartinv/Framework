...
PyCombineHarvesterCombineTools_INIT_FUNC        += $$(eval $$(call PythonProduct,PyCombineHarvesterCombineTools,src/CombineHarvester/CombineTools/python,src_CombineHarvester_CombineTools_python))
else
